...
public class Grid : MonoBehaviour
{
    ...
    // 节点半径
    public float NodeRadius = 0.125f;
    ...
    public class NodeItem
    {
        ...
        public NodeItem(bool isWall, Vector3 pos, int x, int y)
        {
            ...
            showObj = GameObject.CreatePrimitive(PrimitiveType.Sphere);
            showObj.transform.localScale = new Vector3(0.5f, 0.5f, 0.5f);
            showObj.transform.localPosition = pos;
            showObj.SetActive(false);

            _MeshRenderer = showObj.transform.GetComponent<MeshRenderer>();
            _MeshRenderer.sharedMaterial = Resources.Load<Material>("Prefabs/AStarPath/AStar_Node");

            showObj.transform.SetParent(GameObject.Find("Map").transform);
        }

        public void SetShowItemObj(bool isShow)
        {
            showObj.SetActive(isShow);
        }
