...
public class FindPath : MonoBehaviour
{
    ...
    // 生成路径
    private void generatePath(Grid.NodeItem startNode, Grid.NodeItem endNode)
    {
    ...
    IEnumerator ShowCloseList(HashSet<Grid.NodeItem> closeSet)
    {
        foreach (var item in closeSet)
        {
            item.SetShowItemObj(true);
